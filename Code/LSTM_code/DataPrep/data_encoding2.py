...
def labEncoding(infile, outfile):
    ...
    while line:
        ...
        x_val.append([x_lab, data[5]])
        y_val.append([y_lab, [data[2]]])
        #print(x_val)
        #print(y_val)
        line = infp.readline()
    print("save encoding...")
...
def data_split(file):
    ...
    print("train_data")
    d1, d2 = train_test_split(train_data, test_size=0.5)
    outfile1 = file.split(".")[0] + "_1" +".out"
    outfile2 = file.split(".")[0] + "_2" +".out"
    print("split and write to " + outfile1)
...
if __name__ == "__main__":
    ...
    data_split("train_seq1.out")
    data_split("train_seq2.out")
    data_split("train_seq3.out")
    data_split("train_seq4.out")
    data_split("train_seq5.out")
